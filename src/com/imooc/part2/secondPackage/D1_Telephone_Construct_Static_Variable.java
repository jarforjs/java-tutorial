package com.imooc.part2.secondPackage;
...
public class D1_Telephone_Construct_Static_Variable {
  ...
  public D1_Telephone_Construct_Static_Variable() {
    System.out.println("secondPackage:无参的构造方法执行了");
  }
  ...
  public D1_Telephone_Construct_Static_Variable(float newScreen, float newCpu, float newMemory) {
    ...
    cpu = newCpu;
    memory = newMemory;
    System.out.println("secondPackage:有参的构造方法执行了");
    sendMessage();
  }

  // 方法
  void call() {
    System.out.println("secondPackage:telephone有打电话的功能");
  }
}
